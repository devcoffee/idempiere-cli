...
public class AddWListboxEditorCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        return ExitCodeMapper.fromScaffold(scaffoldService.addComponent("wlistbox-editor", name, dir, pluginId,
